    ...
    SELECTED_MODEL,
    {
        initProgressCallback: (info) => {
            ...
            if (info.progress === 1 && !end) {
                ...
                addMessage("Motivo de consulta: Fuerte dolor de cabeza en los últimos 20 días. Además, se reportan antecedentes relevantes de hipoglicemia, sus padres sufren de hipertensión y su abuela materna murió de diabetes, manifiesta tener episodios frecuentes de estrés, paciente con poca actividad física, fuma, toma alcohol y es alérgico a los AINE.", 'bot')
                addMessage("Para un paciente con estas características, es importante abordar tanto los síntomas actuales cómo los factores de riesgo a largo plazo, Aquí tienes un plan de manejo sugerido: 1.Realizar una evaluación médica completa: Realizar estudios para determinar la causa de los dolores de cabeza. Monitorear niveles de glucosa en sangre debido a sus antecedentes y Evaluar presión arterial regularmente, considerando el historial familiar. 2.Modificaciones en su estilo de vida: Actividad física, dieta saludable, dejar de fumar, hidratación y rutinas adecuadas de sueño. 3.Manejo de los dolores de cabeza: Dado que es alérgico a los AINE. considerar alternativas cómo terapias no farmacológicas como compresas frías o técnicas de relajación, identificar y evitar desencadenantes de estrés.", 'bot')
                addMessage("Cómo asistente, mi objetivo es ofrecer información y sugerencias que puedan complementar el criterio clínico y profesional del médico tratante. Reconozco que cada paciente es único y que las decisiones finales sobre su manejo deben ser tomadas por el profesional. Estoy aquí como apoyo y herramienta para enriquecer el proceso de atención médica. ¡Gracias por confiar en mí para colaborar en esta misión tan importante!", 'bot')
                $input.focus()
            }
        }
    }
